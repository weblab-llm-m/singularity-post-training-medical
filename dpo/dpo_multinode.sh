...
srun --jobid $SLURM_JOBID --gpus-per-node=${NPROC_PER_NODE}  singularity run -w --nv -B /home /home/Competition2025/P05/P05U016/hara_ms-swift-megatron_v3.8.1 \
bash 59_dpo_multinode_exec.sh ${MODEL} ${MASTER_PORT}
