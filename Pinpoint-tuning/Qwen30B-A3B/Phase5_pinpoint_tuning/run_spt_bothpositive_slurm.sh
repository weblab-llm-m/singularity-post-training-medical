#!/bin/bash
#SBATCH --job-name=DONT-KILL_spt_bothpositive
...
# SPT Training for Qwen3-30B-A3B-Instruct-2507 (MoE) - both_positive_heads
# Uses DeepSpeed ZeRO-3 for memory-efficient training

set -e

echo "==================================================="
echo "SPT Training for Qwen3-30B-A3B MoE (8 GPU) - both_positive_heads"
echo "==================================================="
...
echo "  Trainable heads: both_positive_heads (378 heads)"
echo "  Train data: igakuqa.jsonl (9374件)"
echo "  GPUs: 8"
echo ""

# SPT configuration
TRAINABLE_HEADS="${BASE_DIR}/Phase5_pinpoint_tuning/trainable_heads_bothpositive.json"
OUTPUT_DIR="${BASE_DIR}/Phase5_pinpoint_tuning/spt_output_bothpositive"
...
echo ""
echo "==================================================="
echo "SPT Training Completed! (both_positive_heads)"
echo "==================================================="
