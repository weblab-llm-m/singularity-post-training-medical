...
def generate_markdown_report(
    ...
    guideline_count = len(classification_results.get('guideline_indicator_heads', []))
...
| Guideline Indicator Heads | {guideline_count} | {guideline_count/total_heads*100:.1f}% |
...
2. **Guideline Indicator Heads** (優先度: 高)
   - ガイドライン参照パターンに対応
   - チューニング対象として推奨
