...
def merge_dictionaries(input_files: List[str], output_file: str):
    ...
    # Merge and deduplicate (profile instead of guidelines for igakuQA)
    merged_dict = {
        "diseases": set(),
...
if __name__ == "__main__":
    ...
    input_files = [
        str(script_dir / "medical_terms_dictionary_qwen_generated_42.json"),
        str(script_dir / "medical_terms_dictionary_qwen_generated_123.json"),
        str(script_dir / "medical_terms_dictionary_qwen_generated_456.json"),
        str(script_dir / "medical_terms_dictionary_qwen_generated_789.json"),
        str(script_dir / "medical_terms_dictionary_qwen_generated_1024.json")
    ]

    output_file = str(script_dir / "medical_terms_dictionary.json")
