#!/bin/bash
# =============================================================
# 8ノード64GPU並列 Path Patching モニタリング (dictionary_260212)
...
echo "==================================================="
echo "Path Patching Monitor - 8 Nodes × 8 GPUs (dictionary_260212)"
...
# SLURM jobs status
echo "--- SLURM Jobs ---"
squeue -u $(whoami) --format="%.10i %.20j %.8T %.10M %.6D %R" 2>/dev/null | grep -E "JOBID|pp260212"
echo ""
