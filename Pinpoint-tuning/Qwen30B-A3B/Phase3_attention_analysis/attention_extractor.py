"""
Attention Extractor for MoE Models
...
class AttentionExtractor:
    ...
    def __init__(
        ...
        Args:
            ...
            num_heads: Query ヘッド数 (default: 32)
            num_kv_heads: KV ヘッド数 (default: None, モデルから取得)
        """
        self.model = model
    ...
    def print_attention_summary(self, attention_patterns: Dict[int, torch.Tensor]):
        ...
        """
        print("\n" + "="*60)
        print("Attention Patterns Summary (MoE Model)")
        print("="*60)
