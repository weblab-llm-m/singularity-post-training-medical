#!/bin/bash
# SPT for 144 Medical Term Heads (Phase 3 Results)
# Training on heads identified via Path Patching analysis

set -e

echo "==================================================="
echo "SPT Training for 144 Medical Term Heads"
echo "==================================================="
...
# Training parameters (optimized for memory efficiency with 144 heads)
USE_LORA=false
PRECISE_LEVEL=4  # Only qkv_proj
LEARNING_RATE=2e-4
BATCH_SIZE=1  # Small batch due to 144 heads
