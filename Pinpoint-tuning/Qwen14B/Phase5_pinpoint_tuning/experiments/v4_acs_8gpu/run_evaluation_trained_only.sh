#!/bin/bash
# Evaluation script for Phase5_v4 Trained Model Only
...
echo "=========================================================================="
echo "Phase5_v4 Trained Model Evaluation - 321 Heads SPT (8 GPUs)"
echo "=========================================================================="
echo ""
...
if [ -f "${RESULTS_DIR}/trained_model_321heads_results.json" ]; then
    echo "Trained Model (Phase5_v4 - 321 Heads SPT, ACS Training):"
