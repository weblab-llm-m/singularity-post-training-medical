...
# -*- coding: utf-8 -*-
'''
Model Evaluation Script for Medical QA
...
def extract_answer(text: str) -> str:
    ...
    # Pattern 2: "Final answer:" or "Answer:" or "答え:" or "正解:"
    answer_patterns = [
    ...
    # Pattern 3: Just look for single letter a-e at the end
        ...
        for idx, row in tqdm(df.iterrows(), total=len(df), desc="Evaluating"):
            ...
            if 'reward_model' in row and isinstance(row['reward_model'], dict):
                ...
                if isinstance(ground_truth, (list, tuple)) and len(ground_truth) > 0:
                    gt_answer = str(ground_truth[0]).strip().lower()
                else:
                    gt_answer = str(ground_truth).strip().lower()
            else:
                continue
