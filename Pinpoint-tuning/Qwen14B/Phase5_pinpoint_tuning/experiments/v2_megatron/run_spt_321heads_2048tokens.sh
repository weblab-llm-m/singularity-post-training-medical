#!/bin/bash
# SPT Training for 321 Important Heads (Megatron-compatible, 2048 tokens)
# Single GPU mode based on Phase5_pinpoint_tuning successful configuration
...
echo "=========================================================================="
echo "SPT Training - 321 Important Heads (Megatron-compatible, 2048 tokens)"
echo "=========================================================================="
echo ""
...
# Build training command (following Phase5_pinpoint_tuning pattern)
...
# Set PYTHONPATH to include Phase5_v2_megatron_config directory
