...
def main():
    parser = argparse.ArgumentParser(description="Head Classifier")
    parser.add_argument(
        "--attention_patterns",
        type=str,
        required=True,
