#!/bin/bash
# Evaluation script for Base Model with Qwen3 Recommended Settings
...
echo "=========================================================================="
echo "Base Model Evaluation - Qwen3 Recommended Settings"
echo "=========================================================================="
echo ""
...
if [ -f "${RESULTS_DIR}/base_model_results.json" ]; then
    echo "Base Model (Qwen3 Recommended Settings):"
