#!/bin/bash
# DDP Distributed Training for Gynecology Data with 8 GPUs
# Training 24 Positive Impact Heads (Medical + Guideline + Reasoning)
# Phase5_v5: Positive impact heads only
...
echo "=========================================================================="
echo "SPT Training (8 GPUs DDP) - 24 Positive Impact Heads (Gynecology Data)"
echo "=========================================================================="
echo ""
...
echo "  Trainable heads: 24 Positive Impact Heads"
echo "    - Medical term heads: 7"
echo "    - Guideline heads: 8"
echo "    - Reasoning flow heads: 9"
echo "  Train data: ${DATA_DIR}/train.parquet"
echo "  Dataset: Gynecology Guideline 2023"
echo "  Samples: 1,761"
...
OUTPUT_DIR="${BASE_DIR}/Phase5_v5_pinpoint_tuning_mk2_8gpu/spt_output"
...
TRAIN_SCRIPT="${BASE_DIR}/Phase5_v5_pinpoint_tuning_mk2_8gpu/run_spt_medical.py"
